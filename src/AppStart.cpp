...
void App::Start() {
    ...
    ballImages.emplace_back(GA_RESOURCE_DIR "/Image/Character/ball-3.png");
    ballImages.emplace_back(GA_RESOURCE_DIR "/Image/Character/ball-2.png");
    ballImages.emplace_back(GA_RESOURCE_DIR "/Image/Character/ball-1.png");
